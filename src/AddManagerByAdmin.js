...
export function AddManagerByAdmin() {
  ...
  const { handleSubmit, handleChange, values, handleBlur, touched, errors } = useFormik({
    ...
    onSubmit: (newManager) => {
      console.log("Form values", newManager);
      addingManager(newManager);
    },
  });
  let addingManager = async (newManager) => {
    await fetch(`${API}/admin/create/manager`, {
      method: "POST",
